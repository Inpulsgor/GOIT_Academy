...
const refs = {
  ...
  mainLi: document.querySelectorAll(".item h2"),
};

const categoriesNumber = refs.mainUl.children.length;
console.log(`В списке ${categoriesNumber} категории.`);

const titles = refs.mainLi;
// console.log(titles);
...
// ==========================================
//* HTML есть список категорий ul#categories.
